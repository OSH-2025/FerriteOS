...
pub extern "C" fn los_sem_create(count: u16, sem_handle: *mut u32) -> u32 {
    if sem_handle.is_null() {
        return SemaphoreError::PtrNull as u32;
    }
...
pub extern "C" fn los_binary_sem_create(count: u16, sem_handle: *mut u32) -> u32 {
    if sem_handle.is_null() {
        return SemaphoreError::PtrNull as u32;
    }
...
pub extern "C" fn los_sem_delete(sem_handle: u32) -> u32 {
...
pub extern "C" fn los_sem_pend(sem_handle: u32, timeout: u32) -> u32 {
...
pub extern "C" fn los_sem_post(sem_handle: u32) -> u32 {
