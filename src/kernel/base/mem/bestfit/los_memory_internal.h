...
#endif
  /* Size and flag of the current node (the high two bits represent a flag,and
   * the rest bits specify the size) */
  UINT32 sizeAndFlag;
} LosMemCtlNode;
...
#define OS_MEM_NODE_ALIGNED_AND_USED_FLAG                                      \
  (OS_MEM_NODE_USED_FLAG | OS_MEM_NODE_ALIGNED_FLAG)
